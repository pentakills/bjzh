...
-- Records of `ey_ad`
-- -----------------------------
INSERT INTO `ey_ad` VALUES ('3', '1', '1', '', '', '/uploads/allimg/20200601/ed814725ec06dbde439bd241d7ae9fa7.png', '0', '0', '', '', '', '', '0', '', '1', '1', '0', '1', '0', 'cn', '1590999905', '1590999929');
...
-- -----------------------------
INSERT INTO `ey_ad_position` VALUES ('1', '首页幻灯', '1440', '591', '', '1', 'cn', '1', '0', '1550027578', '1590999929');
...
-- Records of `ey_admin`
-- -----------------------------
INSERT INTO `ey_admin` VALUES ('1', 'admin', '', 'admin', '', '', '54a008e1ac81f83c47a75eb924bb2ef8', '1591162337', '127.0.0.1', '19', 'fjpbtoa7h4is5mfo0mhedudh54', '0', '-1', 'cn', '1', '1587349773', '0');
...
) ENGINE=MyISAM AUTO_INCREMENT=238 DEFAULT CHARSET=utf8 COMMENT='管理员操作日志表';
...
INSERT INTO `ey_arcmulti` VALUES ('26', 'arclist5ab516d5cb80c16390719c962a30ad6f', 'arclist', '', '30', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (8,8) AND a.channel IN (1) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.add_time desc LIMIT 30', 'a.add_time desc', '', '', 'a:4:{s:3:\\\"row\\\";s:2:\\\"30\\\";s:8:\\\"titlelen\\\";s:2:\\\"30\\\";s:7:\\\"orderby\\\";s:3:\\\"now\\\";s:6:\\\"typeid\\\";s:3:\\\"8,8\\\";}', '1591067031', '1591162300');
INSERT INTO `ey_arcmulti` VALUES ('27', 'arclistfde9887bbe12142f89c99190cd6398dd', 'arclist', '', '1', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (10,10) AND a.channel IN (1) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 1', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:8:\\\"titlelen\\\";s:2:\\\"40\\\";s:5:\\\"limit\\\";s:3:\\\"0,1\\\";s:6:\\\"typeid\\\";s:2:\\\"10\\\";s:7:\\\"infolen\\\";s:2:\\\"60\\\";}', '1591076525', '1591162300');
INSERT INTO `ey_arcmulti` VALUES ('28', 'arclist59a522b611540e84ed8166e622fd4486', 'arclist', '', '2', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (10,10) AND a.channel IN (1) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 2', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:8:\\\"titlelen\\\";s:2:\\\"40\\\";s:5:\\\"limit\\\";s:3:\\\"1,2\\\";s:6:\\\"typeid\\\";s:2:\\\"10\\\";s:7:\\\"infolen\\\";s:2:\\\"60\\\";}', '1591076525', '1591162300');
INSERT INTO `ey_arcmulti` VALUES ('29', 'arclista8f843e63ce4d8484fdd3d2e6dad7007', 'arclist', '', '4', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (10,10) AND a.channel IN (1) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 4', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:8:\\\"titlelen\\\";s:2:\\\"40\\\";s:5:\\\"limit\\\";s:3:\\\"2,4\\\";s:6:\\\"typeid\\\";s:2:\\\"10\\\";s:7:\\\"infolen\\\";s:2:\\\"60\\\";}', '1591076525', '1591162300');
INSERT INTO `ey_arcmulti` VALUES ('30', 'arclist7628ec04de942cccc314a119e6b9b7cf', 'arclist', '', '1', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (11,11) AND a.channel IN (1) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 1', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:8:\\\"titlelen\\\";s:2:\\\"40\\\";s:5:\\\"limit\\\";s:3:\\\"0,1\\\";s:6:\\\"typeid\\\";s:2:\\\"11\\\";s:7:\\\"infolen\\\";s:2:\\\"60\\\";}', '1591076525', '1591162300');
INSERT INTO `ey_arcmulti` VALUES ('31', 'arclist4d031a511161b8a6f421ea6d78bb89ec', 'arclist', '', '4', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (11,11) AND a.channel IN (1) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 4', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:8:\\\"titlelen\\\";s:2:\\\"40\\\";s:5:\\\"limit\\\";s:3:\\\"1,4\\\";s:6:\\\"typeid\\\";s:2:\\\"11\\\";s:7:\\\"infolen\\\";s:2:\\\"60\\\";}', '1591076525', '1591162300');
INSERT INTO `ey_arcmulti` VALUES ('32', 'arclist9725fdb9f73c4b71fd8130ea1dd7d410', 'arclist', '', '8', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (2,12,18,13,14,15,16,19,20,2) AND a.channel IN (2) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 8', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:3:\\\"row\\\";s:1:\\\"8\\\";s:8:\\\"titlelen\\\";s:2:\\\"30\\\";s:7:\\\"infolen\\\";s:2:\\\"30\\\";s:6:\\\"typeid\\\";s:27:\\\"2,12,18,13,14,15,16,19,20,2\\\";}', '1591080220', '1591162300');
...
-- -----------------------------
INSERT INTO `ey_channeltype` VALUES ('1', 'article', '文章模型', '文章', 'article', 'Article', '1', '1', '1', '0', '1', '0', '1591162337');
INSERT INTO `ey_channeltype` VALUES ('4', 'download', '下载模型', '下载', 'download', 'Download', '0', '1', '1', '0', '4', '0', '1591162337');
INSERT INTO `ey_channeltype` VALUES ('2', 'product', '产品模型', '产品', 'product', 'Product', '1', '1', '1', '0', '2', '0', '1591162337');
INSERT INTO `ey_channeltype` VALUES ('8', 'guestbook', '留言模型', '留言', 'guestbook', 'Guestbook', '1', '1', '1', '0', '8', '1509197711', '1591162337');
INSERT INTO `ey_channeltype` VALUES ('6', 'single', '单页模型', '单页', 'single', 'Single', '1', '1', '1', '0', '6', '1523091961', '1591162337');
INSERT INTO `ey_channeltype` VALUES ('3', 'images', '图集模型', '图集', 'images', 'Images', '0', '1', '1', '0', '3', '1523929121', '1591162337');
...
INSERT INTO `ey_config` VALUES ('78', '_cmscopyright', 'yQcK47Jhf63dk6GxEKjM5sw2', 'php', '', 'cn', '0', '1591162300');
...
INSERT INTO `ey_config` VALUES ('80', 'web_is_authortoken', '-1', 'web', '', 'cn', '0', '1591162338');
