...
-- Records of `ey_admin`
-- -----------------------------
INSERT INTO `ey_admin` VALUES ('1', 'admin', '', 'admin', '', '', '54a008e1ac81f83c47a75eb924bb2ef8', '1591144650', '127.0.0.1', '17', 'lpbdkc2c3ulmq12mcv0th94pv2', '0', '-1', 'cn', '1', '1587349773', '0');
...
) ENGINE=MyISAM AUTO_INCREMENT=225 DEFAULT CHARSET=utf8 COMMENT='管理员操作日志表';
...
-- -----------------------------
INSERT INTO `ey_archives` VALUES ('1', '1', '6', '0', '关于我们', '', '0', '0', '0', '0', '0', '', '0', '0', '', '0', '', '', '', '0.00', '0', '', '1', '100', 'cn', '0', '0', '0', '1550027468', '1550042528');
INSERT INTO `ey_archives` VALUES ('2', '5', '6', '0', '联系我们', '', '0', '0', '0', '0', '0', '', '0', '0', '', '0', '', '', '', '0.00', '0', '', '1', '100', 'cn', '0', '0', '0', '1550027520', '1550042310');
INSERT INTO `ey_archives` VALUES ('3', '6', '6', '0', '公司简介', '', '0', '0', '0', '0', '0', '', '0', '0', '', '0', '', '', '', '0.00', '0', '', '1', '100', 'cn', '0', '0', '0', '1550028348', '1550028944');
...
INSERT INTO `ey_archives` VALUES ('12', '10', '1', '0', 'TC11钛合金棒热挤压的常用技术工艺', '/uploads/allimg/20190213/afe3203442ddcf691b2d43c25b1c0f7f.jpg', '0', '0', '0', '0', '0', '', '267', '0', '', '0', '', '', '&nbsp;TC11钛合金棒作为一种稳定的金属，具有硬度高、密度小、耐腐性好的特性，正是因为钛的这些优良性，所以我们会把TC11钛合金和其他金属进行融合，做成钛合金棒，不仅具有钛的原有特性，还有一些新的特性在里面。TC11钛合金棒具有强度高、密度小、', '0.00', '0', '', '1', '100', 'cn', '1', '0', '0', '1550039203', '1587436843');
...
INSERT INTO `ey_archives` VALUES ('32', '8', '1', '0', '荣誉证书二', '/uploads/allimg/20190215/d56b1ed77612c5f7ed01235ec63d000e.jpg', '0', '0', '0', '0', '0', '', '149', '0', '', '0', '', '', '', '0.00', '0', '', '1', '100', 'cn', '1', '0', '0', '1550223600', '1550223600');
INSERT INTO `ey_archives` VALUES ('33', '8', '1', '0', '荣誉证书一', '/uploads/allimg/20190215/7766329d5e3a8dc9e4e5f83d4ce035cd.jpg', '0', '0', '0', '0', '0', '', '236', '0', '', '0', '', '', '', '0.00', '0', '', '1', '100', 'cn', '1', '0', '0', '1550223612', '1550223612');
...
CREATE TABLE `ey_arcmulti` (
  ...
  `update_time` int(11) DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COMMENT='多页标记存储数据表';
...
INSERT INTO `ey_arcmulti` VALUES ('26', 'arclist5ab516d5cb80c16390719c962a30ad6f', 'arclist', '', '30', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (8,8) AND a.channel IN (1) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.add_time desc LIMIT 30', 'a.add_time desc', '', '', 'a:4:{s:3:\\\"row\\\";s:2:\\\"30\\\";s:8:\\\"titlelen\\\";s:2:\\\"30\\\";s:7:\\\"orderby\\\";s:3:\\\"now\\\";s:6:\\\"typeid\\\";s:3:\\\"8,8\\\";}', '1591067031', '1591144447');
INSERT INTO `ey_arcmulti` VALUES ('27', 'arclistfde9887bbe12142f89c99190cd6398dd', 'arclist', '', '1', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (10,10) AND a.channel IN (1) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 1', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:8:\\\"titlelen\\\";s:2:\\\"40\\\";s:5:\\\"limit\\\";s:3:\\\"0,1\\\";s:6:\\\"typeid\\\";s:2:\\\"10\\\";s:7:\\\"infolen\\\";s:2:\\\"60\\\";}', '1591076525', '1591144447');
INSERT INTO `ey_arcmulti` VALUES ('28', 'arclist59a522b611540e84ed8166e622fd4486', 'arclist', '', '2', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (10,10) AND a.channel IN (1) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 2', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:8:\\\"titlelen\\\";s:2:\\\"40\\\";s:5:\\\"limit\\\";s:3:\\\"1,2\\\";s:6:\\\"typeid\\\";s:2:\\\"10\\\";s:7:\\\"infolen\\\";s:2:\\\"60\\\";}', '1591076525', '1591144447');
INSERT INTO `ey_arcmulti` VALUES ('29', 'arclista8f843e63ce4d8484fdd3d2e6dad7007', 'arclist', '', '4', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (10,10) AND a.channel IN (1) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 4', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:8:\\\"titlelen\\\";s:2:\\\"40\\\";s:5:\\\"limit\\\";s:3:\\\"2,4\\\";s:6:\\\"typeid\\\";s:2:\\\"10\\\";s:7:\\\"infolen\\\";s:2:\\\"60\\\";}', '1591076525', '1591144447');
INSERT INTO `ey_arcmulti` VALUES ('30', 'arclist7628ec04de942cccc314a119e6b9b7cf', 'arclist', '', '1', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (11,11) AND a.channel IN (1) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 1', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:8:\\\"titlelen\\\";s:2:\\\"40\\\";s:5:\\\"limit\\\";s:3:\\\"0,1\\\";s:6:\\\"typeid\\\";s:2:\\\"11\\\";s:7:\\\"infolen\\\";s:2:\\\"60\\\";}', '1591076525', '1591144447');
INSERT INTO `ey_arcmulti` VALUES ('31', 'arclist4d031a511161b8a6f421ea6d78bb89ec', 'arclist', '', '4', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (11,11) AND a.channel IN (1) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 4', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:8:\\\"titlelen\\\";s:2:\\\"40\\\";s:5:\\\"limit\\\";s:3:\\\"1,4\\\";s:6:\\\"typeid\\\";s:2:\\\"11\\\";s:7:\\\"infolen\\\";s:2:\\\"60\\\";}', '1591076525', '1591144447');
INSERT INTO `ey_arcmulti` VALUES ('32', 'arclist9725fdb9f73c4b71fd8130ea1dd7d410', 'arclist', '', '8', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (2,12,18,13,14,15,16,19,20,2) AND a.channel IN (2) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 8', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:3:\\\"row\\\";s:1:\\\"8\\\";s:8:\\\"titlelen\\\";s:2:\\\"30\\\";s:7:\\\"infolen\\\";s:2:\\\"30\\\";s:6:\\\"typeid\\\";s:27:\\\"2,12,18,13,14,15,16,19,20,2\\\";}', '1591080220', '1591144447');
...
-- -----------------------------
INSERT INTO `ey_arctype` VALUES ('1', '6', '6', '0', '关于我们', 'guanyuwomen', '/html/guanyuwomen', 'ABOUT US', '0', '', '/uploads/allimg/20190213/b30941e62fcb3902eec95100626d5ccd.jpg', 'lists_single.htm', '', '', '', '为了能实现“提供百分之百满意的客户服务”的诺言，我们配备了专业的管理人员，在全国更有\r\n队伍庞大的技术人员和维修人员，为用户提供完善的售后服务', '100', '0', '0', '1', '0', '0', '1', 'cn', '1550027468', '1550042528', '/uploads/allimg/20190213/1c563d27af60cc16daf3a5b1d4772aa8.jpg');
...
INSERT INTO `ey_arctype` VALUES ('6', '6', '6', '1', '公司简介', 'gongsijianjie', '/html/guanyuwomen/gongsijianjie', 'HOSPITAL INTRODUCTION', '1', '', '', 'lists_single.htm', '', '', '', '', '100', '0', '0', '1', '0', '0', '1', 'cn', '1550028348', '1550042528', '');
INSERT INTO `ey_arctype` VALUES ('7', '6', '6', '1', '发展历程', 'fazhanlicheng', '/html/guanyuwomen/fazhanlicheng', '', '1', '', '', 'lists_single.htm', '', '', '', '', '100', '0', '0', '1', '0', '0', '1', 'cn', '1550028355', '1550042528', '');
INSERT INTO `ey_arctype` VALUES ('8', '6', '1', '1', '荣誉资质', 'rongyuzizhi', '/html/guanyuwomen/rongyuzizhi', 'HONOR', '1', '', '', 'lists_article_product.htm', 'view_article.htm', '', '', '', '100', '0', '0', '1', '0', '0', '1', 'cn', '1550028363', '1550050367', '/uploads/allimg/20190213/561228d0f0fc01449a255b69a49be158.jpg');
...
-- -----------------------------
INSERT INTO `ey_channeltype` VALUES ('1', 'article', '文章模型', '文章', 'article', 'Article', '1', '1', '1', '0', '1', '0', '1591144650');
INSERT INTO `ey_channeltype` VALUES ('4', 'download', '下载模型', '下载', 'download', 'Download', '0', '1', '1', '0', '4', '0', '1591144650');
INSERT INTO `ey_channeltype` VALUES ('2', 'product', '产品模型', '产品', 'product', 'Product', '1', '1', '1', '0', '2', '0', '1591144650');
INSERT INTO `ey_channeltype` VALUES ('8', 'guestbook', '留言模型', '留言', 'guestbook', 'Guestbook', '1', '1', '1', '0', '8', '1509197711', '1591144650');
INSERT INTO `ey_channeltype` VALUES ('6', 'single', '单页模型', '单页', 'single', 'Single', '1', '1', '1', '0', '6', '1523091961', '1591144650');
INSERT INTO `ey_channeltype` VALUES ('3', 'images', '图集模型', '图集', 'images', 'Images', '0', '1', '1', '0', '3', '1523929121', '1591144650');
...
INSERT INTO `ey_config` VALUES ('78', '_cmscopyright', 'oBy2F9o6doo6K8kl2ioGFyky', 'php', '', 'cn', '0', '1591144447');
...
INSERT INTO `ey_config` VALUES ('80', 'web_is_authortoken', '-1', 'web', '', 'cn', '0', '1591144651');
...
INSERT INTO `ey_config` VALUES ('97', 'web_attr_6', '/uploads/allimg/20200421/894df938d674552d28c4987cfe97ce46.png', 'web', '', 'cn', '0', '1587434813');
...
-- -----------------------------
INSERT INTO `ey_single_content` VALUES ('1', '1', '1', '', '1587452734', '1587452734');
...
INSERT INTO `ey_single_content` VALUES ('3', '3', '6', '&lt;p&gt;宝鸡市洪源泽金属材料有限公司在工业钛及钛合金制品专业技术方面积累了独到的专长，对钛精密铸造及钛冷挤压成型相关领域十分精通。依托公司在工业领域多年的钛及钛合金制品配套及服务经验，在满足常规产品顺畅供应的同时并能够适应您特殊技术要求及产品的需要，为您提供专业的钛及钛合金制品连接解决方案，以此保证您的项目圆满运行而永继经营。&amp;nbsp; 企业技术实力雄厚，加工质量可靠，产品交货及时，价格核算合理，欢迎广大用户洽谈业务，双赢合作，共同发展，共创辉煌！&lt;/p&gt;', '1587430093', '1587430093');
