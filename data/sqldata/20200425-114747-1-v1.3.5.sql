...
-- Records of `ey_ad`
-- -----------------------------
INSERT INTO `ey_ad` VALUES ('1', '1', '1', '首页幻灯1', '', '/uploads/allimg/20200421/4af769df89f799d9164ab7492a37052d.jpg', '0', '0', '', '', '', '', '0', '', '1', '1', '1', '1', '0', 'cn', '1550027594', '1587450423');
...
-- -----------------------------
INSERT INTO `ey_ad_position` VALUES ('1', '首页幻灯', '1440', '591', '', '1', 'cn', '1', '0', '1550027578', '1587450423');
...
-- Records of `ey_admin`
-- -----------------------------
INSERT INTO `ey_admin` VALUES ('1', 'admin', '', 'admin', '', '', '54a008e1ac81f83c47a75eb924bb2ef8', '1587786435', '0.0.0.0', '12', 'd09odllj5td5os317lumeims36', '0', '-1', 'cn', '1', '1587349773', '0');
...
) ENGINE=MyISAM AUTO_INCREMENT=161 DEFAULT CHARSET=utf8 COMMENT='管理员操作日志表';
...
INSERT INTO `ey_archives` VALUES ('9', '10', '1', '0', 'TC11钛合金棒的性能和用途有哪些？', '/uploads/allimg/20190213/457d73118c21299b549b0b23ce6f59d7.jpg', '0', '0', '0', '0', '0', '', '261', '0', '', '0', '', '', 'TC11钛合金棒作为一种稳定的金属，具有硬度高、密度小、耐腐性好的特性，正是因为钛的这些优良性，所以我们会把TC11钛合金和其他金属进行融合，做成钛合金棒，不仅具有钛的原有特性，还有一些新的特性在里面。TC11钛棒TC11钛合金棒具有强度高、密度小、', '0.00', '0', '', '1', '100', 'cn', '1', '0', '0', '1550039090', '1587436676');
INSERT INTO `ey_archives` VALUES ('10', '10', '1', '0', 'TC4钛合金性能特点是什么？', '/uploads/allimg/20190213/2c30bace2edda331112d2d84b6979080.jpg', '0', '0', '0', '0', '0', '', '242', '0', '', '0', '', '', 'TC4钛合金性能-&nbsp; &nbsp; 钛是一种新型金属，钛的性能与最纯的碘化钛杂质含量不超过0.1％，但其强度低、塑性高。99.5％工业纯钛的性能为：密度ρ=4.5g/cm3，熔点为172矽钛合金耐磨地坪5℃，导热系数λ=15.24W/（m.', '0.00', '0', '', '1', '100', 'cn', '1', '0', '0', '1550039169', '1587436749');
...
CREATE TABLE `ey_arcmulti` (
  ...
  `update_time` int(11) DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='多页标记存储数据表';
...
INSERT INTO `ey_arcmulti` VALUES ('2', 'arclist9e0d7b8586f83a10dc34715cb1833685', 'arclist', '', '10', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (9,9) AND a.channel IN (1) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 10', 'a.sort_order asc, a.aid desc', '', '', 'a:3:{s:8:\\\"titlelen\\\";s:2:\\\"30\\\";s:7:\\\"infolen\\\";s:2:\\\"85\\\";s:6:\\\"typeid\\\";s:1:\\\"9\\\";}', '1557374575', '1587546504');
INSERT INTO `ey_arcmulti` VALUES ('3', 'arclistacff4a3438d0361a3c0f306eb8c482f0', 'arclist', '', '4', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (3,10,11,3) AND a.channel IN (1) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 4', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:3:\\\"row\\\";s:1:\\\"4\\\";s:8:\\\"titlelen\\\";s:2:\\\"30\\\";s:7:\\\"infolen\\\";s:2:\\\"55\\\";s:6:\\\"typeid\\\";s:9:\\\"3,10,11,3\\\";}', '1557374575', '1587546504');
...
INSERT INTO `ey_arcmulti` VALUES ('17', 'arclist0a2085fbc03e2bf246ba3b0db1082567', 'arclist', '', '8', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (13,13) AND a.channel IN (2) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 8', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:6:\\\"typeid\\\";s:9:\\\"$field.id\\\";s:3:\\\"row\\\";s:1:\\\"8\\\";s:8:\\\"titlelen\\\";s:2:\\\"30\\\";s:2:\\\"id\\\";s:6:\\\"field2\\\";}', '1587368559', '1587546504');
INSERT INTO `ey_arcmulti` VALUES ('18', 'arclist0c7698414e16753ed7a48b00f91f045c', 'arclist', '', '8', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (14,14) AND a.channel IN (2) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 8', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:6:\\\"typeid\\\";s:9:\\\"$field.id\\\";s:3:\\\"row\\\";s:1:\\\"8\\\";s:8:\\\"titlelen\\\";s:2:\\\"30\\\";s:2:\\\"id\\\";s:6:\\\"field2\\\";}', '1587368559', '1587546504');
INSERT INTO `ey_arcmulti` VALUES ('19', 'arclista6b0208abe0f6f7b20b555de61266e5a', 'arclist', '', '8', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (15,15) AND a.channel IN (2) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 8', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:6:\\\"typeid\\\";s:9:\\\"$field.id\\\";s:3:\\\"row\\\";s:1:\\\"8\\\";s:8:\\\"titlelen\\\";s:2:\\\"30\\\";s:2:\\\"id\\\";s:6:\\\"field2\\\";}', '1587368559', '1587546504');
INSERT INTO `ey_arcmulti` VALUES ('20', 'arclist6d68f1f6bd760cd081a82bcbe85d5287', 'arclist', '', '8', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (16,16) AND a.channel IN (2) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 8', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:6:\\\"typeid\\\";s:9:\\\"$field.id\\\";s:3:\\\"row\\\";s:1:\\\"8\\\";s:8:\\\"titlelen\\\";s:2:\\\"30\\\";s:2:\\\"id\\\";s:6:\\\"field2\\\";}', '1587368559', '1587546504');
INSERT INTO `ey_arcmulti` VALUES ('21', 'arcliste8c904966379d498b13bdc86d3a82d60', 'arclist', '', '8', 'SELECT `b`.*,`a`.* FROM `ey_archives` `a` LEFT JOIN `ey_arctype` `b` ON `b`.`id`=`a`.`typeid` WHERE  (  a.typeid IN (12,18,12) AND a.channel IN (2) AND a.arcrank > -1 AND a.status = 1 AND a.is_del = 0 )  AND `a`.`lang` = \'cn\' ORDER BY a.sort_order asc, a.aid desc LIMIT 8', 'a.sort_order asc, a.aid desc', '', '', 'a:4:{s:6:\\\"typeid\\\";s:9:\\\"$field.id\\\";s:3:\\\"row\\\";s:1:\\\"8\\\";s:8:\\\"titlelen\\\";s:2:\\\"30\\\";s:2:\\\"id\\\";s:6:\\\"field2\\\";}', '1587373440', '1587546504');
...
INSERT INTO `ey_arctype` VALUES ('2', '2', '2', '0', '产品中心', 'chanpinzhongxin', '/html/chanpinzhongxin', '', '0', '', '', 'lists_product.htm', 'view_product.htm', '', '', '', '100', '0', '0', '1', '0', '0', '1', 'cn', '1550027482', '1550042274', '/uploads/allimg/20190213/97e1314a5c233d8cf2d66ef3bd633ea0.jpg');
INSERT INTO `ey_arctype` VALUES ('3', '1', '1', '0', '新闻中心', 'xinwenzhongxin', '/html/xinwenzhongxin', '', '0', '', '', 'lists_article.htm', 'view_article.htm', '', '', '为了能实现“提供百分之百满意的客户服务”的诺言，我们配备了专业的管理人员，在全国更有\r\n队伍庞大的技术人员和维修人员，为用户提供完善的售后服务    ', '100', '0', '0', '1', '0', '0', '1', 'cn', '1550027491', '1550042287', '/uploads/allimg/20190213/a5641bfe1b4e82e89d6b2a4c32504598.jpg');
INSERT INTO `ey_arctype` VALUES ('4', '8', '8', '0', '在线留言', 'zaixianliuyan', '/html/zaixianliuyan', 'ONLINE MESSAGE', '0', '', '', 'lists_guestbook.htm', '', '', '', '', '100', '0', '0', '1', '0', '0', '1', 'cn', '1550027506', '1550048834', '/uploads/allimg/20190213/2f3ed688cdda8114c207a3c91d3434ad.jpg');
...
INSERT INTO `ey_arctype` VALUES ('10', '1', '1', '3', '公司新闻', 'gongsixinwen', '/html/xinwenzhongxin/gongsixinwen', '', '1', '', '', 'lists_article.htm', 'view_article.htm', '', '', '', '100', '0', '0', '1', '0', '0', '1', 'cn', '1550030566', '1550042287', '');
INSERT INTO `ey_arctype` VALUES ('11', '1', '1', '3', '疑问解答', 'yiwenjieda', '/html/xinwenzhongxin/yiwenjieda', '', '1', '', '', 'lists_article.htm', 'view_article.htm', '', '', '', '100', '0', '0', '1', '0', '0', '1', 'cn', '1550030574', '1550042287', '');
INSERT INTO `ey_arctype` VALUES ('12', '2', '2', '2', '钛管件', 'taiguanjianqck', '/html/chanpinzhongxin/tiyanzhenduan', '', '1', '', '', 'lists_product.htm', 'view_product.htm', '', '', '', '100', '0', '0', '1', '0', '0', '1', 'cn', '1550044988', '1587448832', '');
INSERT INTO `ey_arctype` VALUES ('13', '2', '2', '2', '钛法兰', 'taifalan', '/html/chanpinzhongxin/guangxueyiqi', '', '1', '', '', 'lists_product.htm', 'view_product.htm', '', '', '', '100', '0', '0', '1', '0', '0', '1', 'cn', '1550044996', '1587448851', '');
INSERT INTO `ey_arctype` VALUES ('14', '2', '2', '2', '钛加工件', 'taijiagongjian', '/html/chanpinzhongxin/jianyanshebei', '', '1', '', '', 'lists_product.htm', 'view_product.htm', '', '', '', '100', '0', '0', '1', '0', '0', '1', 'cn', '1550045004', '1587448869', '');
INSERT INTO `ey_arctype` VALUES ('15', '2', '2', '2', '钛设备', 'taishebei', '/html/chanpinzhongxin/xueyaji', '', '1', '', '', 'lists_product.htm', 'view_product.htm', '', '', '', '100', '0', '0', '1', '0', '0', '1', 'cn', '1550045012', '1587448887', '');
INSERT INTO `ey_arctype` VALUES ('16', '2', '2', '2', '钛材料', 'taicailiao', '/html/chanpinzhongxin/lunyi', '', '1', '', '', 'lists_product.htm', 'view_product.htm', '', '', '', '100', '0', '0', '1', '0', '0', '1', 'cn', '1550045019', '1587448903', '');
...
INSERT INTO `ey_arctype` VALUES ('18', '2', '2', '12', '钛管件', 'taiguanjian', '/html/chanpinzhongxin/tiyanzhenduan/taiguanjian', '', '2', '', '', 'lists_product.htm', 'view_product.htm', '', '', '', '100', '0', '0', '1', '0', '0', '1', 'cn', '1587370606', '1587448832', '');
...
-- -----------------------------
INSERT INTO `ey_channeltype` VALUES ('1', 'article', '文章模型', '文章', 'article', 'Article', '1', '1', '1', '0', '1', '0', '1587786437');
INSERT INTO `ey_channeltype` VALUES ('4', 'download', '下载模型', '下载', 'download', 'Download', '0', '1', '1', '0', '4', '0', '1587786437');
INSERT INTO `ey_channeltype` VALUES ('2', 'product', '产品模型', '产品', 'product', 'Product', '1', '1', '1', '0', '2', '0', '1587786437');
INSERT INTO `ey_channeltype` VALUES ('8', 'guestbook', '留言模型', '留言', 'guestbook', 'Guestbook', '1', '1', '1', '0', '8', '1509197711', '1587786437');
INSERT INTO `ey_channeltype` VALUES ('6', 'single', '单页模型', '单页', 'single', 'Single', '1', '1', '1', '0', '6', '1523091961', '1587786437');
INSERT INTO `ey_channeltype` VALUES ('3', 'images', '图集模型', '图集', 'images', 'Images', '0', '1', '1', '0', '3', '1523929121', '1587786437');
...
CREATE TABLE `ey_config` (
  ...
  `update_time` int(11) DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=106 DEFAULT CHARSET=utf8 COMMENT='系统配置表';
...
INSERT INTO `ey_config` VALUES ('28', 'web_name', '宝鸡市洪源泽金属材料有限公司', 'web', '', 'cn', '0', '1587429787');
...
INSERT INTO `ey_config` VALUES ('33', 'web_copyright', 'Copyright © 2020-2021 宝鸡市洪源泽金属材料有限公司 版权所有', 'web', '', 'cn', '0', '1587429787');
...
INSERT INTO `ey_config` VALUES ('55', 'web_title', '', 'web', '', 'cn', '0', '1587429787');
...
INSERT INTO `ey_config` VALUES ('78', '_cmscopyright', 'pEEg2TaBhMryunCEpTe7fo7j', 'php', '', 'cn', '0', '1587546504');
...
INSERT INTO `ey_config` VALUES ('80', 'web_is_authortoken', '-1', 'web', '', 'cn', '0', '1587786411');
...
INSERT INTO `ey_config` VALUES ('92', 'web_attr_1', '王先生', 'web', '', 'cn', '0', '1587429982');
INSERT INTO `ey_config` VALUES ('93', 'web_attr_2', '1587751525', 'web', '', 'cn', '0', '1587429931');
INSERT INTO `ey_config` VALUES ('94', 'web_attr_3', '1345864549@qq.com', 'web', '', 'cn', '0', '1587429982');
INSERT INTO `ey_config` VALUES ('95', 'web_attr_4', '陕西省宝鸡市高新开发区马营镇宝钛路南段16号', 'web', '', 'cn', '0', '1587429931');
INSERT INTO `ey_config` VALUES ('96', 'web_attr_5', '0917-3226081', 'web', '', 'cn', '0', '1587429931');
...
INSERT INTO `ey_config` VALUES ('104', 'web_attr_8', '/uploads/allimg/20200421/f2048d3707b912c3a3bffdfb7d8ae576.png', 'web', '', 'cn', '0', '1587438418');
...
INSERT INTO `ey_config` VALUES ('103', 'web_attr_7', '欢迎访问宝鸡市洪源泽金属材料有限公司官网', 'web', '', 'cn', '0', '1587429827');
