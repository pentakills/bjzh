<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:56:"./application/admin/template/archives\index_archives.htm";i:1559025856;s:77:"D:\phpStudy\PHPTutorial\WWW\bjzh\application\admin\template\public\layout.htm";i:1559025856;s:81:"D:\phpStudy\PHPTutorial\WWW\bjzh\application\admin\template\archives\tags_btn.htm";i:1559025856;s:77:"D:\phpStudy\PHPTutorial\WWW\bjzh\application\admin\template\public\footer.htm";i:1559036704;}*/ ?>
<!doctype html>
<html>
<head>
                        ...
                        <tr>
                            ...
                            <td class="" style="width: 100%;">
                                <div class="tl" style="padding-left: 10px;">
                                    ...
                                    <a href="<?php echo url($channelRow[$vo['channel']]['ctl_name'].'/edit',array('id'=>$vo['aid'],'typeid'=>\think\Request::instance()->param('typeid'),'gourl'=>$gourl)); ?>" style="<?php if($vo['is_b'] == '1'): ?> font-weight: bold;<?php endif; ?>"><?php echo $vo['title']; ?></a>
                                    <?php else: ?>
                            ...
                            <td class="">
                                <div class="w180 tc">
                                    ...
                                    <a href="<?php echo url($channelRow[$vo['channel']]['ctl_name'].'/edit',array('id'=>$vo['aid'],'typeid'=>\think\Request::instance()->param('typeid'),'gourl'=>$gourl)); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
...
<script type="text/javascript">
    ...
    function quick_release()
    {
        ...
        layer.open({
            ...
            maxmin: true, //开启最大化最小化按钮
            area: ['600px', '520px'],
            content: "<?php echo url('Archives/release', array('iframe'=>2)); ?>",
