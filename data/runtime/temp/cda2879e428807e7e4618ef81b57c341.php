<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:35:"./template/mobile/lists_product.htm";i:1589871258;s:59:"D:\phpStudy\PHPTutorial\WWW\bjzh\template\mobile\header.htm";i:1591147945;s:59:"D:\phpStudy\PHPTutorial\WWW\bjzh\template\mobile\footer.htm";i:1591149210;}*/ ?>
<!DOCTYPE html>
<html>
              ...
              <div class="cont_nav">
                <ul class="one">
                  ...
                  <li class="o_li"> <a href="<?php echo $field['typeurl']; ?>" class="one_a transition <?php echo $field['currentstyle']; ?>">
                    ...
                    <?php ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; endif; ?> </li>
                  <?php ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; ?>
                </ul>
              </div>
              <!-- 左边联系我们-->
