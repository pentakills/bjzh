<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:33:"./template/pc/lists_guestbook.htm";i:1591083966;s:55:"D:\phpStudy\PHPTutorial\WWW\bjzh\template\pc\header.htm";i:1591000128;s:55:"D:\phpStudy\PHPTutorial\WWW\bjzh\template\pc\footer.htm";i:1591079483;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
                          ...
                          <div class="w-form"   style=""> <?php  $typeid = ""; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagGuestbookform = new \think\template\taglib\eyou\TagGuestbookform; $_result = $tagGuestbookform->getGuestbookform($typeid, "default"); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $mod = ($e % 2 );$i= intval($key) + 1;?>
                            <form method="POST"  enctype="multipart/form-data" action="" id="myform">
                              <div class="li-div" >
                                <div class="w-form-section  clearfix" style="">
                                  <div class="w-form-shartText">
                                    <label class="w-label-form"> <span><?php echo $field['itemname_5']; ?></span> <span class="star_note">*</span> </label>
                                    <div class="" style="">
                                      <input class="w-text-form" style="width:100%" type="text"  name="<?php echo $field['attr_5']; ?>" id="number" />
                                    </div>
                                  </div>
                                </div>
                              </div>
                              <div class="li-div" >
                                <div class="w-form-section  clearfix" style="">
                                  <div class="w-form-tel">
                                    <label class="w-label-form"> <span><?php echo $field['itemname_6']; ?></span> <span class="star_note">*</span> </label>
                                    <div class="" style="">
                                      <input class="w-text-form" style="width:100%" type="tel"  name="<?php echo $field['attr_6']; ?>" id="length" >
                                    </div>
                                  </div>
                                </div>
                              </div>
                              <div class="li-div" >
                                <div class="w-form-section  clearfix" style="">
                                  <div class="w-form-Email">
                                    <label class="w-label-form"> <span><?php echo $field['itemname_7']; ?></span> <span class="star_note">*</span> </label>
                                    <div class="" style="">
                                      <input class="w-text-form" style="width:100%" type="email"  name="<?php echo $field['attr_7']; ?>" id="width"/>
                                    </div>
                                  </div>
                                </div>
                              </div>
							  <div class="li-div" >
							    <div class="w-form-section  clearfix" style="">
							      <div class="w-form-Email">
							        <label class="w-label-form"> <span><?php echo $field['itemname_8']; ?></span> <span class="star_note">*</span> </label>
							        <div class="" style="">
							          <input class="w-text-form" style="width:100%" type="email"  name="<?php echo $field['attr_8']; ?>" id="thickness"/>
							        </div>
							      </div>
							    </div>
							  </div>
							  ...
							  <div class="li-div" >
							    <div class="w-form-section  clearfix" style="">
							      <div class="w-form-Email">
							        <label class="w-label-form"> <span><?php echo $field['itemname_9']; ?></span> <span class="star_note">*</span> </label>
							        <div class="" style="">
							          <input id="weight"  class="w-text-form" style="width:100%" type="email"  name="<?php echo $field['attr_9']; ?>" id="weight"/>kg
							        </div>
							      </div>
							    </div>
							  </div>
                            ...
                            function checkForm()
                            {
                              ...
                              {
                                alert('请输入您的<?php echo $field['itemname_5']; ?>');
                                return false;
                              }
                              if(document.getElementById('length').value.length == 0)
                              {
                                alert('请输入您的<?php echo $field['itemname_6']; ?>');
                                return false;
                              }
							  if(document.getElementById('width').value.length == 0)
							  {
							    alert('请输入您的<?php echo $field['itemname_7']; ?>');
							    return false;
							  }
							  if(document.getElementById('thickness').value.length == 0)
							  {
							    alert('请输入您的<?php echo $field['itemname_8']; ?>');
							    return false;
							  }      
                            }
                        ...
                        <div class="li-div">
                          <div class="not-animated w-text" data-animate="" style="">
                            <div style="color:#fff;">
                              ...
                              <p style="line-height:1.5; font-size:90%;">联系人：<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_1"); echo $__VALUE__; ?> &nbsp;&nbsp;电话：<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_2"); echo $__VALUE__; ?><br/>
                                邮箱：<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_3"); echo $__VALUE__; ?>&nbsp;&nbsp;地址：<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_4"); echo $__VALUE__; ?><br/>
                                热线电话：<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_5"); echo $__VALUE__; ?>（二十四小时在线，你的建议或意见使我们前进的动力）<br/>
                              <?php echo htmlspecialchars_decode($global['web_copyright']); ?>--SEO技术支持：<a href="http://www.0917bjms.com/">麦思科技</a> &nbsp;&nbsp;
