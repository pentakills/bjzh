<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:47:"./application/admin/template/archives\index.htm";i:1559025856;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <script type="text/javascript">
        function quick_release()
        {
            ...
            layer.open({
                ...
                area: ['600px', '520px'],
                content: "<?php echo url('Archives/release', array('iframe'=>1)); ?>",
...
<body>
    ...
    <div class="ui-layout-center"><iframe name="content_body" id="content_body" src="<?php echo url('Archives/index_archives'); ?>" width="100%" height="100%" frameborder="0"></iframe></div>
</body>
</html>