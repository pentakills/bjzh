<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:35:"./template/pc/lists_guestbook_s.htm";i:1591082020;s:55:"D:\phpStudy\PHPTutorial\WWW\bjzh\template\pc\header.htm";i:1591000128;s:55:"D:\phpStudy\PHPTutorial\WWW\bjzh\template\pc\footer.htm";i:1591079483;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
                              ...
                              <div class="li-div" >
                                <div class="w-form-section  clearfix" style="">
                                  <div class="w-form-shartText">
                                    ...
                                    <div class="" style="">
                                      <input class="w-text-form" style="width:100%" type="text"  name="<?php echo $field['attr_5']; ?>" id="attr_5" />
                                    </div>
                                  </div>
                                </div>
                              </div>
                              <div class="li-div" >
                                <div class="w-form-section  clearfix" style="">
                                  <div class="w-form-tel">
                                    ...
                                    <div class="" style="">
                                      <input class="w-text-form" style="width:100%" type="tel"  name="<?php echo $field['attr_6']; ?>" id="attr_6" >
                                    </div>
                                  </div>
                                </div>
                              </div>
                              <div class="li-div" >
                                <div class="w-form-section  clearfix" style="">
                                  <div class="w-form-Email">
                                    ...
                                    <div class="" style="">
                                      <input class="w-text-form" style="width:100%" type="email"  name="<?php echo $field['attr_7']; ?>" id="attr_7"/>
                                    </div>
                                  </div>
                                </div>
                              </div>
							  <div class="li-div" >
							    <div class="w-form-section  clearfix" style="">
							      <div class="w-form-Email">
							        ...
							        <div class="" style="">
							          <input class="w-text-form" style="width:100%" type="email"  name="<?php echo $field['attr_8']; ?>" id="attr_8"/>
							        </div>
							      </div>
							    </div>
							  </div>
							  ...
							  <div class="li-div" >
							    <div class="w-form-section  clearfix" style="">
							      <div class="w-form-Email">
							        ...
							        <div class="" style="">
							          <input class="w-text-form" style="width:100%" type="email"  name="<?php echo $field['attr_9']; ?>" id="attr_9"/>
							        </div>
							      </div>
							    </div>
							  </div>
