<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:46:"./application/admin/template/archives\move.htm";i:1559025856;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <script type="text/javascript" src="/public/static/common/js/jquery.min.js?v=v1.3.5"></script>
    <script type="text/javascript" src="/public/plugins/layer-v3.1.0/layer.js?v=v1.3.5"></script>
    <style type="text/css">
        .container-fluid {
            padding: 10px 10px;
            overflow: hidden;
