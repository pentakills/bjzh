<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"./application/admin/template/guestbook\attribute_add.htm";i:1559025856;s:77:"D:\phpStudy\PHPTutorial\WWW\bjzh\application\admin\template\public\layout.htm";i:1559025856;s:77:"D:\phpStudy\PHPTutorial\WWW\bjzh\application\admin\template\public\footer.htm";i:1559036704;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo U('Guestbook/attribute_add'); ?>" method="post" onsubmit="return false;">
        <div class="ncap-form-default">
            ...
            <div class="bot">
                <a href="JavaScript:void(0);" onclick="check_submit('post_form','<?php echo U('Guestbook/attribute_add'); ?>');"  class="ncap-btn-big ncap-btn-green" id="submitBtn">确认提交</a>
        </div>
    </form>
</div>
<script type="text/javascript">
