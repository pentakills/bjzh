<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:48:"./template/mobile/lists_guestbook_tstbtbjsgs.htm";i:1591146862;s:59:"D:\phpStudy\PHPTutorial\WWW\bjzh\template\mobile\header.htm";i:1591147945;s:59:"D:\phpStudy\PHPTutorial\WWW\bjzh\template\mobile\footer.htm";i:1591149210;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
              ...
              <div class="w-title-in">
                <div class="w-title-inner">
                  <div class="title-h-in">
                    <h2 class="color_main color_h" style="">钛丝/钛棒/钛饼计算公式：单位：mm</h2>
                        ...
                        <div class="li-div">
                          <div class="w-form"   style=""> <?php  $typeid = ""; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagGuestbookform = new \think\template\taglib\eyou\TagGuestbookform; $_result = $tagGuestbookform->getGuestbookform($typeid, "default"); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $mod = ($e % 2 );$i= intval($key) + 1;?>
                              ...
                              <div class="li-div" >
                                <div class="w-form-section  clearfix" style="">
                                  <div class="w-form-Email">
                                    <label class="w-label-form"> <span>直径</span> <span class="star_note">*</span> </label>
                                    <div class="" style="">
                                      <input class="w-text-form" style="width:100%" type="number"  name="" id="diameter"/>
                                    </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            function checkForm()
                            {
							  ...
							  if(document.getElementById('diameter').value.length == 0)
							  {
							    alert('请输入您的直径');
							    return false;
							  }
							    ...
							    var diameter   = $("#diameter").val();
                                                           var result = number*diameter*diameter*3.54*length*(1/1000000);
