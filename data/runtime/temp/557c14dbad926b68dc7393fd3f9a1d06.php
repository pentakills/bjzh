<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:47:"./template/mobile/lists_guestbook_tbtfkjsgs.htm";i:1591146705;s:59:"D:\phpStudy\PHPTutorial\WWW\bjzh\template\mobile\header.htm";i:1589869124;s:59:"D:\phpStudy\PHPTutorial\WWW\bjzh\template\mobile\footer.htm";i:1589870522;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
                          ...
                          <div class="w-form"   style=""> <?php  $typeid = ""; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagGuestbookform = new \think\template\taglib\eyou\TagGuestbookform; $_result = $tagGuestbookform->getGuestbookform($typeid, "default"); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $mod = ($e % 2 );$i= intval($key) + 1;?>
                            <form method="POST"  enctype="multipart/form-data" action="" id="myform">
                              ...
                              <div class="li-div" >
                                <div class="w-form-section  clearfix" style="">
                                  <div class="w-form-tel">
                                    <label class="w-label-form"> <span>长</span> <span class="star_note">*</span> </label>
                                    <div class="" style="">
                              ...
                              <div class="li-div" >
                                <div class="w-form-section  clearfix" style="">
                                  <div class="w-form-Email">
                                    <label class="w-label-form"> <span>宽</span> <span class="star_note">*</span> </label>
                                    <div class="" style="">
                                      <input class="w-text-form" style="width:100%" type="number"  name="" id="width"/>
                                    </div>
                                  </div>
                                </div>
                              </div>
							  <div class="li-div" >
							    <div class="w-form-section  clearfix" style="">
							      <div class="w-form-Email">
							        <label class="w-label-form"> <span>厚度</span> <span class="star_note">*</span> </label>
							        <div class="" style="">
