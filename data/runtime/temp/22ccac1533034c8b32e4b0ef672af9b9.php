<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:34:"./template/mobile/view_article.htm";i:1589871296;s:59:"D:\phpStudy\PHPTutorial\WWW\bjzh\template\mobile\header.htm";i:1591147945;s:59:"D:\phpStudy\PHPTutorial\WWW\bjzh\template\mobile\footer.htm";i:1589870522;}*/ ?>
<!DOCTYPE html>
<html>
<!-- 提交压缩包记得要恢复，浏览时记得删除 -->
          ...
          <div id="model_contant_main" class="container"> 
            ...
            <div class="moder_leftright_r">
              ...
              <div class="model-dectil">
                <div class="model-dectil-title"><?php echo $eyou['field']['title']; ?> <span><?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:4:"fbrq";}'); echo $__VALUE__; ?>：<?php echo MyDate('Y-m-d H:i:s',$eyou['field']['add_time']); ?> &nbsp; <?php  $tagLang = new \think\template\taglib\eyou\TagLang; $__VALUE__ = $tagLang->getLang('a:1:{s:4:"name";s:4:"llcs";}'); echo $__VALUE__; ?>：<?php  $tagArcclick = new \think\template\taglib\eyou\TagArcclick; $__VALUE__ = $tagArcclick->getArcclick("", ""); echo $__VALUE__; ?></span></div>
                ...
                <div class="model-dectil-bottom">
                  ...
                  <?php endif;  $tagPrenext = new \think\template\taglib\eyou\TagPrenext; $_result = $tagPrenext->getPrenext("next");if(!empty($_result) || (($_result instanceof \think\Collection || $_result instanceof \think\Paginator ) && $_result->isEmpty())): $field = $_result; ?>
