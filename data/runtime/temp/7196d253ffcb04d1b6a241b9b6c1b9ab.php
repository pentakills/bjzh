<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"./application/admin/template/product\edit.htm";i:1587449538;s:77:"D:\phpStudy\PHPTutorial\WWW\bjzh\application\admin\template\public\layout.htm";i:1559025856;s:82:"D:\phpStudy\PHPTutorial\WWW\bjzh\application\admin\template\field\addonextitem.htm";i:1559025856;s:77:"D:\phpStudy\PHPTutorial\WWW\bjzh\application\admin\template\public\footer.htm";i:1559036704;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo url('Product/edit'); ?>" method="post">
        ...
        <div class="ncap-form-default tab_div_1">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="users_price" value="<?php echo $field['users_price']; ?>" id="users_price" class="input-txt" maxlength="100">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>-->
